...
func PostLikedBy(path, post_id, col string) ([]structs.User, error) {
	var q *sql.Rows
	...
	default:
		return []structs.User{}, errors.New("incorrect column")
	}
...
func UserLiked(path, user_id, col string) ([]structs.Post, error) {
	var q *sql.Rows
	...
	default:
		return []structs.Post{}, errors.New("incorrect column")
	}
